...
////Store to list
//List<Employee> ListEmployee = new List<Employee> { emp1, emp2, emp3, emp4,prog,sal,qual };
...
var empSalaryRange = empinf.FindSalaryRange(listOfEmps, 3_000_000, 5_500_000);
